...
[SECTION_3_CONTENT]
<!-- 예시: 코드 리뷰 요구사항, 테스트 게이트, 배포 승인 절차, 이슈 완료 후 PR 생성 규칙, 리뷰 코멘트 답글 규칙 등 -->

## 거버넌스
<!-- 예시: 헌장이 다른 관행보다 우선하며, 개정에는 문서화와 승인, 마이그레이션 계획이 필요하다. -->

[GOVERNANCE_RULES]
<!-- 예시: 모든 PR과 리뷰는 헌장 준수 여부를 확인해야 하며, 이슈 단위 작업 완료 후 PR을 생성하고, 리뷰 코멘트는 반영 여부와 사유를 답글로 남기고, 복잡도 증가는 정당화가 필요하다. -->
